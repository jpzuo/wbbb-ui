...
export const HALO_DATE_FORMAT = 'YYYY-MM-DD'
export type HaloDateLocale = 'en' | 'zh-cn'

export function getDate(value?: string, format = HALO_DATE_FORMAT): Dayjs | undefined {
  if (!value) {
    return undefined
  }
...
export function formatDate(value: Dayjs, format = HALO_DATE_FORMAT) {
  return value.format(format)
}

export function getWeekdays(locale: HaloDateLocale, firstDayOfWeek: 0 | 1) {
